...
def main() -> None:
    ...
    for time_interval in time_intervals:
        ...
        for index, (lo_time, hi_time) in enumerate(possible_time_windows):
            ...
            tss_df.to_csv(f"{metrics_directory}{time_interval_caption}_b_mx_lda_tss.csv")
            mx_recall_df.to_csv(f"{metrics_directory}{time_interval_caption}_b_mx_lda_recall.csv")
