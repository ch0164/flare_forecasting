...
if __name__ == "__main__":
    ...
    def get_title(metric):
        return f"Time Window Mean Analysis, {metric} from LDA Classifier Using LOO CV, for NB/MX Flares"
    ...
    plt.savefig(
        f"/home/ch0164/PycharmProjects/flare_forecasting/results/time_window_classification/figures/"
